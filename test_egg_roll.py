...
class TestEggRoll(unittest.TestCase):
    ...
    def test_calculate_points(self):
        ...
        for max_moves, moves, res in test_cases:
            moves = ['→']*moves
            self.assertEqual(game_utils.calculate_points(max_moves, moves), res)

    def test_set_position(self):
        """Test setting each cell as an egg"""
        grid1 = [
                ['🧱', '🧱', '🧱', '🧱', '🧱'],
                ['🧱', '🟩', '🥚', '🟩', '🧱'],
                ['🧱', '🪹', '🟩', '🍳', '🧱'],
        ...
        grids = [grid1, grid2, grid3, grid_cs11, grid_sacrifice]

        # This is actually not possible when playing a game level. (Eggs can only move in grass blocks)
        # The objective of this test, therefore, is to verify that the function
